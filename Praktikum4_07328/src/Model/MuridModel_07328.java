...
public class MuridModel_07328 
{
    ...
    public ArrayList<MuridEntity_07328> getMurid_07328(String nama){
        ArrayList<MuridEntity_07328> arrayListMurid = new ArrayList<>();
        try{
            sql_mitha = "SELECT * FROM murid where nama=?";
            PreparedStatement stat = conn.prepareStatement(sql_mitha);
